...
"https://project-backend-cgtf.onrender.com/fee-structure",
{
...
res = await fetch(
`https://project-backend-cgtf.onrender.com/fee-structure/${editingId}`,
{
method:"PUT",
headers:{
...
const res = await fetch(
`https://project-backend-cgtf.onrender.com/fee-structure/${id}`,
{
method:"DELETE",
headers:{ Authorization:`Bearer ${token}` }
}
