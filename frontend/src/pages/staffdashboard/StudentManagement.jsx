...
export default function StudentManagement() {
  ...
  const getStudents = async () => {
    ...
    const res = await fetch("http://localhost:4000/staff/students",{
      headers:{
  ...
  const createStudent = async () => {
    ...
    await fetch("http://localhost:4000/staff/create-student",{
      method:"POST",
      headers:{
  ...
  const updateStudent = async () => {
    ...
    await fetch(`http://localhost:4000/staff/students/${form.registerNo}`,{
      method:"PUT",
      headers:{
        "Content-Type":"application/json",
        Authorization:`Bearer ${token}`
  ...
  const deleteStudent = async(registerNo)=>{
    ...
    await fetch(`http://localhost:4000/staff/students/${registerNo}`,{
      method:"DELETE",
      headers:{
        Authorization:`Bearer ${token}`
      }
