...
export default function AttendanceManagement() {
  ...
  const loadStudents = async () => {
    ...
    const res = await fetch(
      `https://project-backend-cgtf.onrender.com/attendance/students?department=${department}&year=${Number(year)}&semester=${Number(semester)}`,
  ...
  const fetchAttendancePercentage = async (student) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://project-backend-cgtf.onrender.com/attendance/percentage/${student._id}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  const submitAttendance = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://project-backend-cgtf.onrender.com/attendance/mark",
        {
          method: "POST",
          headers: {
